...
public class UserProfileLockDto {
    private Long id;
    private Long userId;
    private String name;
    ...
    public Boolean getBorrowLock() { return borrowLock; }
    public void setBorrowLock(Boolean borrowLock) { this.borrowLock = borrowLock; }
